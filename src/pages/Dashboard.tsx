...
const Dashboard = () => {
  ...
  const focusAreas = [
    { id: 1, name: 'Product Innovation', progress: 65 },
    { id: 2, name: 'Team Leadership', progress: 40 },
    { id: 3, name: 'Growth Strategy', progress: 80 },
  ];
      ...
      <div className="lg:col-span-2 space-y-8">
        <NeumorphCard title="Daily Focus" className="animate-fade-in">
          <div className="grid md:grid-cols-3 gap-4">
            {focusAreas.map(area => (
              <div key={area.id} className="flex flex-col items-center p-4 neumorph-inner rounded-xl">
        ...
        <NeumorphCard title="Top ROI Task" className="animate-fade-in" style={{ animationDelay: '0.1s' }}>
        ...
        <NeumorphCard title="What Not To Do Today" className="animate-fade-in" style={{ animationDelay: '0.2s' }}>
          <div className="p-4 neumorph-inner rounded-xl">
      ...
      <div className="space-y-8">
        <NeumorphCard className="animate-fade-in" style={{ animationDelay: '0.3s' }}>
          <div className="text-center p-6">
            ...
            <h3 className="text-xl font-semibold mb-2">CEO Ritual</h3>
        ...
        <NeumorphCard title="Daily Progress" className="animate-fade-in" style={{ animationDelay: '0.4s' }}>
        ...
        <NeumorphCard title="Growth Log" className="animate-fade-in" style={{ animationDelay: '0.5s' }}>
