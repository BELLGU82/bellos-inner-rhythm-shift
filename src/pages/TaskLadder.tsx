...
const TaskLadder = () => {
  ...
  const getEmotionIcon = (emotion: TaskType['emotion']) => {
    switch (emotion) {
      case 'positive': return <Heart size={16} className="text-green-500" />;
      case 'neutral': return <Heart size={16} className="text-blue-500" />;
      case 'draining': return <Heart size={16} className="text-red-500" />;
    ...
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-4">
          ...
          <h2 className="text-2xl font-bold">ROI Task Ladder</h2>
        </div>
                ...
                {task.status !== 'done' && (
                  <>
                    ...
                    <NeumorphButton 
                      ...
                      onClick={() => changeTaskStatus(task.id, 'deferred')}
