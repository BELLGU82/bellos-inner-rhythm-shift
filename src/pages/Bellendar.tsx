...
const sampleEvents: EventType[] = [
  { id: 1, title: 'Team Meeting', time: '9:00 AM', duration: 1, energyLevel: 'high', type: 'meeting', hour: 9 },
  { id: 2, title: 'Strategic Planning', time: '11:00 AM', duration: 2, energyLevel: 'high', type: 'focus', hour: 11 },
  { id: 3, title: 'Email & Admin', time: '2:00 PM', duration: 1, energyLevel: 'low', type: 'admin', hour: 14 },
  { id: 4, title: 'Product Development', time: '3:30 PM', duration: 2.5, energyLevel: 'medium', type: 'focus', hour: 15 },
  { id: 5, title: 'Mindfulness Break', time: '6:00 PM', duration: 0.5, energyLevel: 'medium', type: 'rest', hour: 18 },
];
...
const Bellendar = () => {
  ...
  const getEnergyLevelIcon = (level: EventType['energyLevel']) => {
    switch (level) {
      ...
      case 'medium': return <Battery size={16} className="text-blue-500" />;
      case 'low': return <Battery size={16} className="text-gray-500" />;
      default: return <Battery size={16} className="text-gray-500" />;
    }
  };
    ...
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-4">
          ...
          <h2 className="text-2xl font-bold">Bellendar</h2>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div>
          <NeumorphCard className="animate-fade-in">
            <div className="grid grid-cols-7 gap-2 mb-4">
              {DAYS.map(day => (
                <div key={day} className="text-center font-medium text-bell-muted text-sm py-2">
                  {day}
                </div>
              ))}
            </div>
              ...
              {days.map(day => (
                <button
                  ...
                  className={`
                    ...
                    ${day === selectedDay 
                      ? 'neumorph-inner bg-bell-primary bg-opacity-10 text-bell-primary font-medium' 
            ...
            <div className="mt-6">
              ...
              <div className="neumorph-inner p-4 rounded-xl">
                ...
                <div className="h-2 bg-bell-subtle rounded-full overflow-hidden">
                  <div 
                    className="h-full bg-bell-primary rounded-full"
        ...
        <div className="lg:col-span-2">
          <NeumorphCard 
            title={`April ${selectedDay}, ${currentYear}`} 
            className="animate-fade-in h-full"
          >
            <div className="relative">
              {HOURS.map(hour => (
                <div key={hour} className="flex items-start mb-6">
                  ...
                  <div className="flex-1 min-h-[60px] border-t border-bell-subtle pt-1">
                    {eventsForDay
                      ...
                      .map(event => (
                        <div 
                          key={event.id}
                          className={`mb-2 p-3 rounded-lg ${getEventTypeColor(event.type)}`}
                          style={{ 
